...
export const sfxTexts = ["ドン!!", "ドドン!!", "バン!!", "バキッ", "ズバッ", "ズガン!!", "ガン!!", "ドカン!!", "ゴッ", "ズン!!", "シュッ", "ギュン", "ビュン", "ヒュッ", "ザッ", "サッ", "バッ", "キュン", "バチッ", "ビリッ", "ジジジ", "ギャリッ", "ノイズ", "グワン", "ギュルル", "ズザザ", "CRASH!!", "BOOM!!", "BREAK!!", "BLAST!!", "SMASH!!", "BANG!!", "ズン", "ドゥン", "ゴゴゴ", "ドドド", "ブォン", "グワッ", "シン…", "ゾワ…", "ギシ…", "ザワ…"];
